...
# run the program
python savefeats_file.py -p "./instances/txt/Amazon0302.txt" -ps "./feats/" &

sleep 1

python savefeats_file.py -p "./instances/txt/Amazon0312.txt" -ps "./feats/" &

sleep 1

python savefeats_file.py -p "./instances/txt/Amazon0505.txt" -ps "./feats/" &

sleep 1

python savefeats_file.py -p "./instances/txt/Amazon0601.txt" -ps "./feats/" &

sleep 1

python savefeats_file.py -p "./instances/txt/com-dblp.ungraph.txt" -ps "./feats/" &
